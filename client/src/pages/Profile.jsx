...
const Profile = () => {
  ...
  return (
      <>
        <div 
          className={
            "bg-green-950 flex justify-center h-60 gap-2 p-6 transition-all duration-[2000ms] " 
            + (slide ? "w-full opacity-100" : "w-0 opacity-0")}
          >
          <img
            src="img/Gaben.png"
            alt="Page LOGO"
            className={"w-36 rounded-full transition-all duration-[4000ms] " + (slide ? "opacity-100" : "opacity-0")}
          />
          <div className={"flex flex-col transition-all duration-[4000ms] " + (slide ? "opacity-100" : "opacity-0")}>
          ...
          <div className="grid grid-flow-col grid-cols-3 gap-4">
            <div className="col-span-2">
              <div className="relative p-5 rounded-3xl bg-slate-200 text-slate-400 font-thin shadow-[5px_5px]">
                ...
                <p className="underline underline-offset-8 decoration-1 decoration-gray-400/80 text-2xl">Configuración de cuenta</p>
                <form action="">
            ...
            <div>
              <div className="relative p-5 rounded-3xl bg-slate-200 text-slate-400 font-thin shadow-[5px_5px] shadow-green-900">
                ...
                <p className="underline underline-offset-8 decoration-1 decoration-gray-400/80  text-green-900 text-2xl">Última entrada</p>
              </div>
              <div className="m-4">
                  <div onClick={() => navigate("/reminders")} className="bg-slate-200 p-4 rounded-3xl text-lg cursor-pointer hover:shadow-[5px_5px] hover:shadow-green-950 hover:text-white hover:bg-green-800 transition-all">
                    <i className="fa-solid fa-circle-info size-fit"></i>
                    <span className="line-clamp-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut, unde quaerat laboriosam asperiores ea reiciendis dolore repellat aliquid dolorem perspiciatis magnam ipsam nam eligendi quae fugit pariatur similique. Et, voluptatum!</span>
                  </div>
                </div>
            </div>
          </div>
